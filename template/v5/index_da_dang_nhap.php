<?php include 'header_da_dang_nhap.php'; ?>
    ...
    <div class="ic-install-app">
        <div class="container">
            <div class="col col-1">
                <div class="ic-home-login-welcome">
                    <h5>Xin chào</h5>
                    <div class="media">
                        <div class="media-left">
                            <a href="#">
                                <img src="images/q/av-2.png" alt="" title="" width="85" height="85" />
                            </a>
                        </div>

                        <div class="media-body">
                            <a>
                                <strong>Nguyễn Trạng</strong>
                            </a>

                            <div class="ic-point">
                                1.000 <span>iCheck Point</span>
                            </div>
                            <p>Trong lúc Trump đe dọa sử dụng vũ lực chống lại Triều Tiên</p>
                        </div>
                    </div>

                    <a href="#" class="ic-button-follow">Theo dõi ngay</a>
                </div>
            </div>
